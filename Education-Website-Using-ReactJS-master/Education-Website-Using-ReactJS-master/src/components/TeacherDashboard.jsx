...
const TeacherDashboard = () => {
    ...
    const styles = {
        ...
        cancelBtn: { padding: "12px 30px", background: "#f0f2f5", color: "#666", border: "none", borderRadius: "8px", cursor: "pointer", fontSize: "15px", boxShadow: "none" },
        ...
        editBtn: { background: "#1eb2a6", color: "white", border: "none", padding: "6px 12px", borderRadius: "6px", cursor: "pointer", fontSize: "13px", marginRight: "6px", boxShadow: "none" },
        deleteBtn: { background: "#ff4757", color: "white", border: "none", padding: "6px 12px", borderRadius: "6px", cursor: "pointer", fontSize: "13px", boxShadow: "none" },
        ...
        <div style={styles.wrapper}>
            <div style={styles.sidebar}>
                <div style={styles.sidebarInner}>
                    ...
                    <div style={styles.navSection}>COURSES</div>
                    <div style={styles.navItem(activeTab === "addcourse")} onClick={() => { setActiveTab("addcourse"); setEditingCourse(null); setForm({ title: "", description: "", price: "", instructor: "", classTime: "" }); }}>➕ Add Course</div>
                    <div style={styles.navItem(activeTab === "manage")} onClick={() => setActiveTab("manage")}>📋 Manage Courses</div>
                </div>
            </div>
            ...
            <div style={styles.main}>
                <div style={styles.topbar}>
                    <div style={{ display: "flex", alignItems: "center", gap: "15px" }}>
                        ...
                        <span style={{ fontWeight: "bold", color: "#1eb2a6" }}>Teacher Panel</span>
                    </div>
                ...
                <div style={styles.content}>
                    <div style={styles.pageTitle}>
                        ...
                        {activeTab === "addcourse" && (editingCourse ? "Edit Course" : "Add New Course")}
                        {activeTab === "manage" && "Manage Courses"}
                    </div>
                    <div style={styles.pageSubtitle}>Science E-Learning Teacher Panel</div>
                        ...
                        <>
                            <div style={styles.statsGrid}>
                                ...
                                <div style={styles.statCard("#0f8a80")}>
                                    <div style={styles.statNumber}>${courses.reduce((sum, c) => sum + Number(c.price || 0), 0)}</div>
                                    <div style={styles.statLabel}>💰 Total Value</div>
                                </div>
                            </div>
                            <div style={styles.card}>
                                <div style={styles.cardTitle}>📚 My Courses</div>
                    ...
                    {activeTab === "addcourse" && (
                        <div style={styles.card}>
                            <div style={styles.cardTitle}>{editingCourse ? "✏️ Edit Course" : "➕ Add New Course"}</div>
                            ...
                            <form onSubmit={handleSubmit}>
                                ...
                                <div style={{ marginTop: "15px" }}>
                                    <button type="submit" style={styles.submitBtn}>{editingCourse ? "Update Course" : "Add Course"}</button>
                                    {editingCourse && <button type="button" style={styles.cancelBtn} onClick={() => { setEditingCourse(null); setForm({ title: "", description: "", price: "", instructor: "", classTime: "" }); }}>Cancel</button>}
                                </div>
                            </form>
                        </div>
                    )}
                    ...
                    {activeTab === "manage" && (
                        <div style={styles.card}>
                            <div style={styles.cardTitle}>📋 Manage Courses</div>
                            {message && <div style={styles.alert}>{message}</div>}
                            <table style={styles.table}>
                                <thead>
                                    <tr>
